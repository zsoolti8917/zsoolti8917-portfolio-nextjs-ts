...
I have a master's degree in Applied Informatics, and alongside my studies I spent three years testing other people's websites, which is where I learned to care about what happens after the deploy. Since then I've picked up the unglamorous half of the job: data pipelines, Linux, networking, backups. I experiment with new technology every day, AI included. I believe in agentic development, with the developer leading the agents: breaking the work down, delegating tasks and staying accountable for the result. AI tools are the compilers of our decade: learn them or be left behind. Outside work there's a homelab that has grown well past what I can justify, a motorcycle, and a ski season I never get enough of.
