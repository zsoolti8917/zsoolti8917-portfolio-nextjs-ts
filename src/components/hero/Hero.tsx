 ...
 *
 * A STATIC import chain on purpose. The window opens on the one block the
 * server has already run — `whoami` — so the name, the role, the current
 * work, the location and the stack are legible to a recruiter on first paint
 * and complete to a crawler that never runs JavaScript; the project titles
 * are in the Projects section of the same document. The shell enhances that
